...
public class ImpactAnalysisService {
    ...
    /**
     * Analisa impacto de uma decisão ou evento na empresa.
     * 
     * @param companyId ID da empresa
     * @param eventDate Data do evento
     * @param eventDescription Descrição do evento
     * @return ImpactAnalysisDTO com métricas antes/depois e mudanças
     */
    ...
    /**
     * Calcula score de moral baseado em stress e intensidade.
     */
    ...
    /**
     * Calcula score de engajamento baseado em conversas e usuários ativos.
     */
    ...
    /**
     * Calcula mudanças percentuais entre períodos.
     */
    ...
    /**
     * Determina tendência geral baseada nas mudanças.
     */
    ...
    /**
     * Analisa impacto por departamento.
     */
    private List<ImpactAnalysisDTO.DepartmentImpact> analyzeDepartmentImpacts(
        ...
        for (UUID deptId : beforeByDept.keySet()) {
            if (afterByDept.containsKey(deptId)) {
                ...
                double moraleChange = -stressChange; // Inverso do stress
                ...
                impacts.add(new ImpactAnalysisDTO.DepartmentImpact(
                    deptId,
                    null, // Nome seria buscado do user-service
                    stressChange,
                    moraleChange,
                    impactLevel
                ));
    ...
    /**
     * Gera avaliação geral do impacto.
     */
